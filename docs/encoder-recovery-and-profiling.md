...
[benchmark-data/mivf_benchmark_data_audit.md](benchmark-data/mivf_benchmark_data_audit.md).
...
[PERFORMANCE_TUNING.md](PERFORMANCE_TUNING.md#motion-search-modes) land around 43 dB on
comparable content.
