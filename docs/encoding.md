...
| `--motion-search {full,diamond,fast,hybrid,hierarchical}` | Motion search algorithm; see [cli-reference.md](cli-reference.md#quality-and-motion-search) and [PERFORMANCE_TUNING.md](PERFORMANCE_TUNING.md#motion-search-modes) |
...
[encoder-recovery-and-profiling.md](encoder-recovery-and-profiling.md) for the full
...
See [PERFORMANCE_TUNING.md](PERFORMANCE_TUNING.md#e2-benchmarking-jobs-and-chunk-frames)
...
sidecar files, not encoder flags — see [FILES_AND_SIDECARS.md](FILES_AND_SIDECARS.md) and
